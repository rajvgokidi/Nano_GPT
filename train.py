...
class MultiAttentionAttention(nn.Module):
...
class Block(nn.Module):
    # n_emb is embedding dimensions and n_head is the number of attention heads
    def __init__(self, n_embd, n_head):
        super().__init__()
        head_size = n_embd // n_head
        self.sa = MultiAttentionAttention(n_embd, head_size)
